...
extern ALLEGRO_SAMPLE* BIGPOWER_SOUND;
extern ALLEGRO_SAMPLE* WALKING_SOUND;
extern uint32_t GAME_TICK;
static ALLEGRO_SAMPLE_ID BIGPOWER;
static ALLEGRO_SAMPLE_ID WALK;
...
void pacman_eatItem(Pacman* pacman, const char Item) {
	...
	case 'P':
		stop_bgm(BIGPOWER);
		BIGPOWER = play_audio(BIGPOWER_SOUND, effect_volume);
		break;
	default:
		break;
	}
